...
public class InputJadwalSidangTaActivity extends AppCompatActivity {

    private PendingIntent pendingIntent;
    private static final int ALARM_REQUEST_CODE = 133;

    EditText edtKelas, edtJudul, edt_Ruangan;
    AutoCompleteTextView edtNama, edt_Pembimbing1, edt_Pembimbing2, edt_Penguji1, edt_Penguji2, edt_Penguji3;
    ...
    private static String url = Config.HOST+"input_jdw_sd_ta.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_input_jadwal_sd_ta);

        StrictMode.ThreadPolicy policy = new StrictMode.ThreadPolicy.Builder().permitAll().build();
        StrictMode.setThreadPolicy(policy);

        getSupportActionBar().setTitle("Input Data Sidang TA");
        ...
        edt_Penguji3 = (AutoCompleteTextView) findViewById(R.id.edt_penguji3);
        ...
        btnSimpan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(tanggal == null){
                    Toast.makeText(InputJadwalSidangTaActivity.this, "Tanggal harus ditentukan", Toast.LENGTH_SHORT).show();
                }
                else if(waktu == null){
                    Toast.makeText(InputJadwalSidangTaActivity.this, "Waktu harus ditentukan", Toast.LENGTH_SHORT).show();
                }else{
                    ...
                    new prosesSimpan(nama, kelas, judul, pbb1, pbb2, pgj1, pgj2, pgj3, ruangan, tanggal, waktu).execute();
                }
            }
        });
...
//                return rtdp;
    ...
    private class prosesSimpan extends AsyncTask<Void,Void,String> {
        ...
        private int scs = 0;
        private String psn;
        private String nama, kelas, judul, pembimbing1, pembimbing2, penguji1, penguji2, penguji3, ruangan, tgl, waktu;
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(InputJadwalSidangTaActivity.this);
        ...
        protected void onPostExecute(String s) {
            pDialog.dismiss();
            if(scs == 1){
                Toast.makeText(InputJadwalSidangTaActivity.this, psn, Toast.LENGTH_SHORT).show();
                finish();
                Intent intent = new Intent(InputJadwalSidangTaActivity.this, JadwalSidangTaActivity.class);
...
//            pDialog.dismiss();
            if (scs == 1) {
                ...
                adapterMhs = new ArrayAdapter<String>
                        (InputJadwalSidangTaActivity.this, android.R.layout.select_dialog_item, data_user);

                edtNama.setThreshold(1);
                edtNama.setAdapter(adapterMhs);
            } else {
                Toast.makeText(InputJadwalSidangTaActivity.this, "Terjadi kesalahan saat memuat data dosen", Toast.LENGTH_SHORT).show();
            }
    ...
    private class getDataDsnKoor extends AsyncTask<Void,Void,String> {
        ...
        protected void onPostExecute(String s) {
            ...
            if (scs == 1) {
                ...
                edt_Penguji3.setThreshold(1);
                edt_Penguji3.setAdapter(adapter);
            } else {
                Toast.makeText(InputJadwalSidangTaActivity.this, "Terjadi kesalahan saat memuat data dosen", Toast.LENGTH_SHORT).show();
            }
    ...
    private void buatNotifikasi(String judul){
        try {
            ...
            String strJsonBody = "{"
                    ...
                    +   "\"data\": {\"foo\": \"bar\"},"
                    +   "\"contents\": {\"en\": \"Jadwal Sidang: "+judul+"\"}"
                    + "}";
    ...
    private void triggerAlarmManager(){
        ...
        Intent alarmIntent = new Intent(InputJadwalSidangTaActivity.this, AlarmReceiver.class);
        alarmIntent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
        pendingIntent = PendingIntent.getBroadcast(InputJadwalSidangTaActivity.this, ALARM_REQUEST_CODE, alarmIntent, 0);
