...
public class SessionManager {
    ...
    private static final String PREF_NAME = "AkadomaPref";
    ...
    public static final String KEY_NOTLP_USER = "key_notlp_user";
     ...
     */
    public void createLoginSession(String level, String id_user, String nama, String no_tlp) {
        // Storing login value as TRUE
        editor.putBoolean(IS_LOGIN, true);
        editor.putString(KEY_LEVEL, level);
        editor.putString(KEY_ID_USER, id_user);
        editor.putString(KEY_NM_USER, nama);
        editor.putString(KEY_NOTLP_USER, no_tlp);
    ...
    public HashMap<String, String> getUserDetails() {
        ...
        user.put(KEY_NOTLP_USER, pref.getString(KEY_NOTLP_USER, null));
        // return user
        return user;
    }
