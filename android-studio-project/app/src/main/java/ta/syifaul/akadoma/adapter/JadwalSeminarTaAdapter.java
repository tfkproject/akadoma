...
public class JadwalSeminarTaAdapter extends RecyclerView.Adapter<JadwalSeminarTaAdapter.ViewHolder> {
    ...
    public JadwalSeminarTaAdapter(Context context, List<ItemJadwalSeminarTa> items, AdapterListener listener) {
    ...
    @Override
    public JadwalSeminarTaAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_seminar_ta, parent, false);
        ...
        if(level.contains("koorta")){
            holder.cardView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    listener.onSelected(
                            position,
                            items.get(position).getId_seminarta(),
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        CardView cardView;
        TextView txtTanggal, txtWaktu, txtRuangan, txtNama, txtKelas, txtJudul, txtPbb1, txtPbb2, txtPngj1, txtPngj2, txtSisaWaktu;
