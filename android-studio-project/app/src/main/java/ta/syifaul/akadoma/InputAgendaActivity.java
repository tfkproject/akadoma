...
public class InputAgendaActivity extends AppCompatActivity {
    ...
    private static String url = Config.HOST+"input_agenda.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        session = new SessionManager(InputAgendaActivity.this);

        getSupportActionBar().setTitle("Input Agenda");
    ...
    private class prosesSimpan extends AsyncTask<Void,Void,String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(InputAgendaActivity.this);
        ...
        protected void onPostExecute(String s) {
            pDialog.dismiss();
            if(scs == 1){
                Toast.makeText(InputAgendaActivity.this, psn, Toast.LENGTH_SHORT).show();
                finish();
                triggerAlarmManager();
            }
            else{
    ...
    private void triggerAlarmManager(){
        ...
        Intent alarmIntent = new Intent(InputAgendaActivity.this, AlarmReceiver.class);
        alarmIntent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
        pendingIntent = PendingIntent.getBroadcast(InputAgendaActivity.this, ALARM_REQUEST_CODE, alarmIntent, 0);
        ...
        editor.putString("judul", "Agenda: "+edtJudul.getText().toString());
        ...
        Toast.makeText(this, "Agenda telah diset", Toast.LENGTH_SHORT).show();
    }
}
