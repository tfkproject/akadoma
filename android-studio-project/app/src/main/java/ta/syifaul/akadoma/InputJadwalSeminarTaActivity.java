...
public class InputJadwalSeminarTaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_input_jadwal_sm_ta);

        StrictMode.ThreadPolicy policy = new StrictMode.ThreadPolicy.Builder().permitAll().build();
        StrictMode.setThreadPolicy(policy);

        getSupportActionBar().setTitle("Input Data Seminar TA");
    ...
    private class prosesSimpan extends AsyncTask<Void,Void,String> {
        ...
        private int scs = 0;
        private String psn;
        private String nama, kelas, judul, pembimbing1, pembimbing2, penguji1, penguji2, ruangan, tgl, waktu;
        ...
        protected void onPostExecute(String s) {
            ...
            if(scs == 1){
                ...
                finish();
                Intent intent = new Intent(InputJadwalSeminarTaActivity.this, JadwalSeminarTaActivity.class);
...
//            pDialog.dismiss();
    ...
    private void triggerAlarmManager(){
        ...
        Intent alarmIntent = new Intent(InputJadwalSeminarTaActivity.this, AlarmReceiver.class);
        alarmIntent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
        pendingIntent = PendingIntent.getBroadcast(InputJadwalSeminarTaActivity.this, ALARM_REQUEST_CODE, alarmIntent, 0);
