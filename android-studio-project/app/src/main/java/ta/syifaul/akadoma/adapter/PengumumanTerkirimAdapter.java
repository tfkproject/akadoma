...
public class PengumumanTerkirimAdapter extends RecyclerView.Adapter<PengumumanTerkirimAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        String tujuan = items.get(position).getTujuan();
        if(tujuan.equals("mhs")){
            tujuan = "Mahasiswa";
        }
        if(tujuan.equals("dsn")){
            tujuan = "Dosen";
        }
        if(tujuan.equals("koorkp")){
            tujuan = "Koordinator KP";
        }
        if(tujuan.equals("koorta")){
            tujuan = "Koordinator TA";
        }
        if(tujuan.equals("sma")){
            tujuan = "Semua";
        }
        holder.txtTujuan.setText(tujuan);
    }
    @Override
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        CardView cardView;
        TextView txtJudul, txtTanggal, txtWaktu, txtNama, txtTujuan;
